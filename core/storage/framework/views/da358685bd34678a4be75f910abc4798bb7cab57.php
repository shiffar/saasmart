            ...
            <div class="col-md-12">
                <div class="recent-order-wrapper dashboard-table bg-white padding-30">
                    <div class="header-wrap">
                        ...
                        <p><?php echo e(__("Manage all integrations from here, you can active/deactivate integrations.")); ?></p>
                    </div>
    ...
    <div class="modal fade" tabindex="-1" id="messenger_modal">
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <form action="<?php echo e(route(route_prefix().'integration')); ?>" method="post">
                    <?php echo csrf_field(); ?>
                ...
                <form action="<?php echo e(route(route_prefix().'integration')); ?>" method="post">
                    ...
                    <div class="modal-body">
                        ...
                        <?php if(is_null(tenant())): ?>
                            <div class="form-group">
                                <label for=""><strong><?php echo e(__("Tenant")); ?></strong></label>
                                <label class="switch">
                                    <input type="checkbox" name="adroll_pixels_tenant"
                                           <?php if(!empty($method("adroll_pixels_tenant"))): ?> checked <?php endif; ?>>
                                    <span class="slider onff"></span>
                                </label>
                                <small><?php echo e(__("load this script in tenant websites")); ?></small>
                            </div>
                        <?php endif; ?>
                    </div>
                    <div class="modal-footer">
                            ...
                            <div class="form-group">
                                ...
                                <label class="switch">
                                    <input type="checkbox" name="facebook_pixels_tenant"
                                           <?php if(!empty($method("facebook_pixels_tenant"))): ?> checked <?php endif; ?>>
                                    <span class="slider onff"></span>
                                </label>
                                <small><?php echo e(__("load this script in tenant websites")); ?></small>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <label class="switch">
                                    <input type="checkbox" name="google_analytics_gt4_tenant"
                                           <?php if(!empty($method("google_analytics_gt4_tenant"))): ?> checked <?php endif; ?>>
                                    <span class="slider onff"></span>
                                </label>
                                <small><?php echo e(__("load this script in tenant websites")); ?></small>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <label class="switch">
                                    <input type="checkbox" name="google_tag_manager_tenant"
                                           <?php if(!empty($method("google_tag_manager_tenant"))): ?> checked <?php endif; ?>>
                                    <span class="slider onff"></span>
                                </label>
                                <small><?php echo e(__("load this script in tenant websites")); ?></small>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <label class="switch">
                                    <input type="checkbox" name="site_google_captcha_v3_tenant"
                                           <?php if(!empty($method("site_google_captcha_v3_tenant"))): ?> checked <?php endif; ?>>
                                    <span class="slider onff"></span>
                                </label>
                                <small><?php echo e(__("load this script in tenant websites")); ?></small>
                            </div>
            ...
            $(document).on("click", '.pl_active_deactive', function (e) {
                ...
                Swal.fire({
                    ...
                    if (result.isConfirmed) {
                        ...
                        axios.post("<?php echo e(route(route_prefix()."integration.activation")); ?>", {
