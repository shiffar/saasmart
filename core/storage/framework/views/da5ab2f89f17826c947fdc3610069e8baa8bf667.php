    ...
    <div class="navbar-menu-wrapper d-flex align-items-stretch">
        ...
        <ul class="navbar-nav navbar-nav-right">
            ...
            <li class="nav-item nav-logout d-none d-lg-block mx-2">
                <a class="btn <?php echo e($warning ? 'btn-danger site-health-btn' : 'btn-success'); ?> btn-icon-text"
...
<?php /**PATH C:\laragon\www\nazmart\core\resources\views/landlord/admin/partials/topbar.blade.php ENDPATH**/ ?>