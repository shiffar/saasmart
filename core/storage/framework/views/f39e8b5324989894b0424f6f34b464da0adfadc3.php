            ...
            <div class="row justify-content-center">
                <div class="col-lg-12">
                    <div class="copyright-contents center-text">
                        <span> <?php echo get_footer_copyright_text(\App\Facades\GlobalLanguage::default_slug()); ?> </span>
                    </div>
                </div>
            </div>
        </div>
...
<?php /**PATH C:\laragon\www\nazmart\core\resources\views/landlord/frontend/partials/footer.blade.php ENDPATH**/ ?>